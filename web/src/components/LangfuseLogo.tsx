    ...
    <DropdownMenu>
      ...
      {/* <DropdownMenuContent>
        {hasUpdate ? (
          <>
            <DropdownMenuLabel>
              {t("version.New version", { type: checkUpdate.data?.updateType ?? "" })}
          ...
          <>
            <DropdownMenuLabel>{t("version.This is the latest release")}</DropdownMenuLabel>
            <DropdownMenuSeparator />
          </>
        ) : null}
        {isEeVersion && (
...
export const LangfuseLogo = ({
  ...
  >
    ...
    <div className="flex items-center">
      ...
      <span className="ml-2 text-sm">{VERSION}</span>
