...
export default function ScoresTable({
  ...
  const rawColumns: LangfuseColumnDef<ScoresTableRow>[] = [
    ...
    {
      accessorKey: "userId",
      header: t("table.traceUserId"),
      id: "userId",
      headerTooltip: {
        description: t("table.traceUserIdTooltip"),
    ...
    },
    {
      ...
      enableSorting: true,
      cell: ({ row }) => {
        const value = row.getValue("dataType");
        return <span>{t(`filters.${value}`)}</span>;
      },
    },
    {
      accessorKey: "value",
    ...
    },
    {
      ...
      header: t("table.jobConfigurationId"),
      id: "jobConfigurationId",
      headerTooltip: {
        description: t("table.jobConfigurationIdTooltip"),
