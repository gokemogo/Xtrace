                ...
                >
                  <div className="flex gap-2">
                    ...
                    {observation.children.length === 0 ? null : (
                      <Toggle
                        ...
                        className="w-7"
                        title={
                          collapsed ? t("trace.expandChildren") : t("trace.collapseChildren")
                        }
                      >
                        {collapsed ? (
                  ...
                  {observation.level !== "DEFAULT" ? (
                    <div className="flex">
                      ...
                      >
                        {t(`ObservationLevel.${observation.level}`)}
                      </span>
                    </div>
                  ) : null}
                  {props.showScores &&
...
const ColorCodedObservationType = (props: {
  ...
  return (
    ...
    >
      {t(`common.${props.observationType}`)}
    </span>
  );
};
