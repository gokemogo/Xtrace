    ...
    <>
      {!props.disabled ? (
        <Select onValueChange={setEvalTemplate} value={evalTemplate}>
          ...
          >
            <SelectValue placeholder={t("evalConfigs.form.selectTemplatePlaceholder")} />
          </SelectTrigger>
          <SelectContent>
            {props.evalTemplates
              .sort(
      ...
      >
        <div className="grid gap-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("evalConfigs.form.scoreNameLabel")}</FormLabel>
                <FormControl>
                  <Input {...field} />
                </FormControl>
                <FormMessage />
          ...
          <Card className="flex flex-col gap-6 p-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("evalConfigs.form.targetLabel")}</FormLabel>
                  <FormControl>
                    <Tabs defaultValue="trace">
                      <TabsList {...field}>
                        <TabsTrigger value="trace">{t("evalConfigs.form.targetOptionTrace")}</TabsTrigger>
                        <TabsTrigger value="observation" disabled={true}>
                          {t("evalConfigs.form.targetOptionObservation")}
                        </TabsTrigger>
                      </TabsList>
                    </Tabs>
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("evalConfigs.form.filterLabel")}</FormLabel>
                  <FormControl>
                    <InlineFilterBuilder
                  ...
                  <FormDescription>
                    {t("evalConfigs.form.filterDescription")}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <Card className="p-4">
            <FormField
              ...
              render={() => (
                <>
                  <FormLabel className="">{t("evalConfigs.form.variableMappingLabel")}</FormLabel>
                  <FormControl>
                    {t("evalConfigs.form.variableMappingPlaceholder")}
                  </FormControl>
                  <div className="my-2 flex flex-col gap-2 lg:flex-row">
                    <JSONView
                      title={t("evalConfigs.Eval Template")}
                      ...
                      {fields.map((mappingField, index) => (
                        <Card className="flex flex-col gap-2 p-4" key={index}>
                          <div className="text-sm font-semibold	">
                            ...
                            {"}}"}
                            <DocPopup
                              description={t("evalConfigs.form.templateVarDocDescription")}
                              size="xs"
                            />
                          </div>
                          <FormField
                            ...
                            render={({ field }) => (
                              <div className="flex  items-center gap-2">
                                <VariableMappingDescription
                                  title={t("evalConfigs.form.traceObjectTitle")}
                                  description={t("evalConfigs.form.traceObjectDescription")}
                                />
                                        ...
                                        {availableEvalVariables.map(
                                          (evalObject) => (
                                            <SelectItem
                                              ...
                                              key={evalObject.id}
                                            >
                                              {t(`evalObject.${evalObject.display}`)}
                                            </SelectItem>
                                          ),
                                        )}
                                      </SelectContent>
                          ...
                          {form.watch(`mapping.${index}.langfuseObject`) !==
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <div className="flex items-center gap-2">
                                  <VariableMappingDescription
                                    title={t("evalConfigs.form.Object Name")}
                                    description={t("evalConfigs.form.VariableMappingDescription")
                                    }
                                  />
                                  <FormItem className="w-2/3">
                                    <FormControl>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <div className="flex items-center gap-2">
                                <VariableMappingDescription
                                  title={t("evalConfigs.form.Object Variable")}
                                  description={t('evalConfigs.form.VariablDescription')}
                                />
                                <FormItem className="w-2/3">
                                  <FormControl>
                                    <Select
                                    ...
                                    >
                                      <SelectTrigger>
                                        <SelectValue placeholder={t("evalConfigs.form.objectTypePlaceholder")} />
                                      </SelectTrigger>
                                      <SelectContent>
                                        {availableEvalVariables
                                          .find(
                  ...
                  <FormDescription>
                    {t("evalConfigs.form.promptTemplate")}
                  </FormDescription>
                  <FormMessage />
                </>
              )}
          ...
          <Card className="flex flex-col gap-6 p-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("evalConfigs.form.Sampling")}</FormLabel>
                  <FormControl>
                    <Slider
                      disabled={props.disabled}
                      min={0}
                  ...
                  <div className="flex flex-col">
                    ...
                    <FormDescription>
                      {t("evalConfigs.form.PercentageOfTraces")}
                    </FormDescription>
                  </div>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("evalConfigs.form.Delay (seconds)")}</FormLabel>
                  <FormControl>
                    <Input {...field} />
                  </FormControl>
                  <FormDescription>
                    {t("evalConfigs.form.ensureAllTraceData")}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
...
function VariableMappingDescription(p: {
  ...
  return (
    <div className="flex w-1/2 items-center">
      ...
      <DocPopup description={p.description} size="xs" />
    </div>
  );
}
