  ...
  const copyButton = output ? (
    <div className="absolute right-3 top-2 space-x-1 opacity-50">
      <Button
        ...
        title={t("playground.Toggle Input/Output JSON")}
      >
        <BracesIcon size={15} />
      </Button>
      ...
      <Button
        ...
        title={t("playground.Copy output")}
      >
    ...
    <div className="relative h-full overflow-auto">
      ...
      >
        <div className="mb-4 flex w-full items-center">
          <p className="flex-1 text-xs font-semibold">{t("playground.Output")}</p>
          {copyButton}
        </div>
        <pre
