...
export const ModelUsageChart = ({
  ...
  return (
    <DashboardCard
      className={className}
      title={t("dashboard.modelUsageTitle")}
            ...
            content: (
              <>
                ...
                {!isEmptyTimeSeries(item.data) ? (
                  ...
                  <NoData noDataText={t("dashboard.noDataAvailable")} />
                )}
              </>
            ),
          };
