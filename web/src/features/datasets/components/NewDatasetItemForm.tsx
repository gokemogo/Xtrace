    ...
    <Form {...form}>
      ...
      >
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t("datasets.Dataset")}</FormLabel>
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <FormControl>
                  <SelectTrigger>
                    <SelectValue placeholder={t("datasets.Select a dataset")} />
                  </SelectTrigger>
                </FormControl>
                <SelectContent>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col gap-2">
                <FormLabel>{t("io.input")}</FormLabel>
                <FormControl>
                  <JsonEditor
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col gap-2">
                <FormLabel>{t("datasets.Expected Output")}</FormLabel>
                <FormControl>
                  <JsonEditor
                    defaultValue={field.value}
                    onChange={field.onChange}
