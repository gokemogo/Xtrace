...
import { multiSelectConstantType } from "@/src/features/filters/components/constant";
                ...
                {selectedValues.size > 2 ? (
                  ...
                  getSelectedOptions().map((option) => (
                    <Badge
                      ...
                      className="rounded-sm px-1 font-normal"
                    >
                      {multiSelectConstantType.includes(option.value) ? t(`filters.${option.value}`) : option.value}
                    </Badge>
                  ))
                )}
              </div>
