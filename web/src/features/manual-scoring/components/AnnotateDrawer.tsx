...
const getFormError = ({
  ...
  if (
    ...
    return {
      type: "custom",
      message: `不在规则中: [${minValue ?? "-∞"},${maxValue ?? "∞"}]`,
    };
  }
  return null;
};
        ...
        <div className="mx-auto w-full overflow-y-auto md:max-h-full">
          <DrawerHeader className="sticky top-0 z-10 rounded-sm bg-background">
            <Header
              ...
              level="h3"
              help={{
                description: t("score.Annotate Help", { type: observationId ? "observation" : "trace" }),
                              ...
                              <Popover>
                                <PopoverTrigger asChild>
                                  <Button
                                    ...
                                    type="button"
                                    size="xs"
                                    title={t("score.Add or view score comment")}
                                    ...
                                    render={({ field }) => (
                                      <FormItem className="space-y-4">
                                        <FormLabel className="text-sm">
                                          {t("manualscoring.Comment (optional)")}
                                        </FormLabel>
                                        {!!field.value &&
                                        ...
                                        >
                                          <SelectTrigger>
                                            <div className="text-xs">
                                              <SelectValue placeholder={t("score.Select category")} />
                                            </div>
                                          </SelectTrigger>
                                          <SelectContent>
                                            {categories.map(
                                ...
                                <Popover key={score.id}>
                                  ...
                                  <PopoverContent>
                                    <h2 className="text-md mb-3 font-semibold">
                                      {t("score.Your score is archived")}
                                    </h2>
                                    <p className="mb-3 text-sm">
                                      {t("score.This action will delete your score irreversibly")}
                                    </p>
