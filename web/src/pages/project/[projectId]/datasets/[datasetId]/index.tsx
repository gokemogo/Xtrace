  ...
  return (
    <FullScreenPage>
      ...
      {!!dataset.data?.metadata && (
        <JSONView json={dataset?.data.metadata} title={t("common.Metadata")} />
      )}
      ...
      <DatasetRunsTable
        ...
        menuItems={
          <Tabs value="runs">
            <TabsList>
              <TabsTrigger value="runs">{t("datasets.Runs")}</TabsTrigger>
      ...
      <p className="mt-3 text-xs text-muted-foreground">
        {t("datasets.Add new runs via Python or JS/TS SDKs")}
      </p>
    </FullScreenPage>
  );
}
